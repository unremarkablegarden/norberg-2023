...
#index(v-if='doc && doc.data')
  ...
  .splash
    ...
    .video.md_absolute.md_flex.flex-col.justify-center.items-center.top-0
      .mask.scale-50.md_scale-100.xl_scale-110.2xl_scale-150(class='-translate-x-[250px] -translate-y-[170px]').md_-translate-x-0.md_-translate-y-0
    ...
    .bottom
      Marquee
      .more.flex.justify-center.items-center.flex-col.pt-6.md_pt-8
